...
public class EventId {
    public static long ACCOUNT_LOGIN=0x1;
    public static long ACCOUNT_LOGOT=0x2;
    public static long ROOM_CREATE=0x3;
    ...
    public static long ROOM_ANGEL=0x7;

    public static long MY_FNAS_LIST=0x11;
    public static long MY_INCOME_LIST=0x12;
    public static long MY_LIVE_LIST=0x13;

    public static long FANS_CONR_DAY=0x21;
