 ...
 *******************************************************************************/
package toolbox.ll.com.pulltorefresh.pulltorefresh.internal;
...
import static toolbox.ll.com.pulltorefresh.pulltorefresh.PullToRefreshBase.Mode.PULL_FROM_END;
...
//		Drawable arrowD = getResources().getDrawable(R.drawable.indicator_arrow);
		Drawable arrowD = getResources().getDrawable(R.mipmap.ic_launcher);
